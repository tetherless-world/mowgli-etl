...
def test_swow_extractor(pipeline_storage, sample_swow_strengths_path, sample_archive_path):
    ...
    with open(extraction[STRENGTH_FILE_KEY], mode='r') as extracted_strengths_file:
        contents = extracted_strengths_file.read()
    with open(sample_swow_strengths_path, mode='r') as sample_strengths_file:
