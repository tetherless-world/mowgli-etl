    ...
    with open(wdc_json_clean_file_path, "r") as data:
        for count,entry in enumerate(data):
            ...
            if count == 12:
                ...
                assert dimensions[0].dimensions.accuracy(SOURCE_KEY[dimensions[0].field]) == 0.5
                ...
                assert dimensions[1].dimensions.accuracy(SOURCE_KEY[dimensions[1].field]) == 0.25
                ...
                assert dimensions[2].dimensions.accuracy(SOURCE_KEY[dimensions[2].field]) == 0.375
    ...
    with open(wdc_large_json_file_path, "r") as data:
        for count,entry in enumerate(data):
            ...
            if count == 24:
                ...
                assert dimensions[0].dimensions.accuracy(SOURCE_KEY[dimensions[0].field]) == 1

                assert dimensions[1].dimensions.weight.value == 368.0
                assert dimensions[1].dimensions.weight.unit == "g"
                assert dimensions[1].dimensions.accuracy(SOURCE_KEY[dimensions[1].field]) == 0.75
