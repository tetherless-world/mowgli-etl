...
from mowgli_etl.lib.etl.pipeline.rpi_combined.rpi_combined_extractor import RpiCombinedExtractor
...
class RpiCombinedPipeline(_Pipeline):
    ...
    def __default_pipelines(self) -> Tuple[_Pipeline, ...]:
        ...
        from mowgli_etl.lib.etl.pipeline.aristo.aristo_pipeline import AristoPipeline
        from mowgli_etl.lib.etl.pipeline.eat.eat_pipeline import EatPipeline
        from mowgli_etl.lib.etl.pipeline.food_on.food_on_pipeline import FoodOnPipeline
        from mowgli_etl.lib.etl.pipeline.has_part.has_part_pipeline import HasPartPipeline
        from mowgli_etl.lib.etl.pipeline.swow.swow_pipeline import SwowPipeline
        from mowgli_etl.lib.etl.pipeline.usf.usf_pipeline import UsfPipeline
        from mowgli_etl.lib.etl.pipeline.web_child.web_child_pipeline import WebChildPipeline
